...
export class OnboardingView extends LitElement {
    ...
    renderSlide() {
        if (this.currentSlide === 0) {
            return html`
                <div class="slide">
                    <div class="slide-title">Assistance</div>
                    <div class="slide-text">Real-time AI assistant that listens, watches, and helps during interviews, meetings, and exams.</div>
                    <div class="actions">
